      ...
      >
        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-3">
            <Button
              variant="outline"
              className="bg-card/50 border-border text-muted-foreground hover:bg-accent hover:text-accent-foreground hover:border-accent transition-all duration-200 group"
            >
              <svg
                className="w-5 h-5 mr-2 text-muted-foreground group-hover:text-accent-foreground transition-colors duration-200"
                viewBox="0 0 24 24"
              >
                <path
                  fill="currentColor"
