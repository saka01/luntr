        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <section id="qualification" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Who Qualifies for Home Office Deduction</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
                To claim home office expenses on your T2125, you must meet specific CRA requirements:
              </p>

              <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-6">
                <h3 className="text-lg  text-blue-900 mb-2">CRA Requirements:</h3>
            ...
            <section id="expense-types" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Types of Home Office Expenses</h2>
              
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-lg  text-slate-900 mb-3">Direct Expenses (100% deductible)</h3>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-lg  text-slate-900 mb-3">Indirect Expenses (percentage deductible)</h3>
                  <ul className="space-y-1 text-slate-600 text-sm">
            ...
            <section id="calculation-methods" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Calculation Methods</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Method 1: Square Footage Method</h3>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Method 2: Room Count Method</h3>
                  <div className="bg-slate-50 p-4 rounded text-sm">
                    <p className=" mb-2">Formula:</p>
            ...
            <section id="percentage-calculation" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">How to Calculate Business Percentage</h2>
              
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 mb-6">
                <div className="p-6">
                  <h3 className="text-lg  text-slate-900 mb-4">Step-by-Step Calculation</h3>
                  <div className="space-y-4">
                    <div>
                      <h4 className=" text-slate-800 mb-2">Step 1: Measure Your Home Office</h4>
                      <p className="text-slate-600 text-sm">Measure the length and width of your home office area in feet or meters.</p>
                    </div>
                    <div>
                      <h4 className=" text-slate-800 mb-2">Step 2: Calculate Office Area</h4>
                      <p className="text-slate-600 text-sm">Multiply length × width to get the square footage of your home office.</p>
                    </div>
                    <div>
                      <h4 className=" text-slate-800 mb-2">Step 3: Measure Total Home Area</h4>
                      <p className="text-slate-600 text-sm">Measure your entire home's square footage (excluding garage, unfinished basement, etc.).</p>
                    </div>
                    <div>
                      <h4 className=" text-slate-800 mb-2">Step 4: Calculate Percentage</h4>
              ...
              <div className="bg-green-50 border-l-4 border-green-400 p-6">
                <h3 className="text-lg  text-green-900 mb-2">Example Calculation:</h3>
                ...
                <div className="bg-white p-4 rounded text-sm">
                  ...
                  <p className="mt-2 ">Sarah can deduct 10% of her indirect home expenses</p>
                </div>
              </div>
            </section>
            ...
            <section id="examples" className="mb-12">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Example 1: Freelance Writer</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="text-sm text-slate-600 space-y-1">
                        ...
                        <p className="">Total direct: $3,700</p>
                      </div>
                    </div>
                    <div>
                      <h4 className=" text-slate-800 mb-2">Indirect Expenses (10% deductible):</h4>
                      <div className="text-sm text-slate-600 space-y-1">
                        <p>• Rent: $24,000 × 10% = $2,400</p>
                        <p>• Utilities: $3,600 × 10% = $360</p>
                        <p>• Internet: $1,200 × 100% = $1,200</p>
                        <p>• Home insurance: $1,200 × 10% = $120</p>
                        <p className="">Total indirect: $4,080</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 p-4 bg-slate-50 rounded">
                    <p className=" text-slate-900">Total home office deduction: $7,780</p>
                  </div>
                </div>

                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Example 2: Graphic Designer</h3>
                  <p className="text-slate-600 mb-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="text-sm text-slate-600 space-y-1">
                        ...
                        <p className="">Total direct: $6,200</p>
                      </div>
                    </div>
                    <div>
                      <h4 className=" text-slate-800 mb-2">Indirect Expenses (15% deductible):</h4>
                      <div className="text-sm text-slate-600 space-y-1">
                        ...
                        <p className="">Total indirect: $3,795</p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 p-4 bg-slate-50 rounded">
                    <p className=" text-slate-900">Total home office deduction: $9,995</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-200">
              <h3 className="text-2xl  text-slate-900 mb-4 text-center">Calculate Your Home Office Deduction</h3>
