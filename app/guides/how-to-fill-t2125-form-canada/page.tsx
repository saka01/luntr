        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <section id="before-you-start" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Before You Start</h2>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 mb-6">
                <div className="p-6">
                  <h3 className="text-lg font-semibold text-slate-900 mb-4">Required Information</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Business Information</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Financial Records</h4>
                      <ul className="space-y-1 text-slate-600 text-sm">
            ...
            <section id="part-1-identification" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Part 1: Identification</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 1: Business Name</h3>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 2: Business Type</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 3: Fiscal Period</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 4: Business Address</h3>
                  <p className="text-slate-600 text-sm mb-3">
            ...
            <section id="part-2-income" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Part 2: Income</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 1: Gross Business Income</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 2: Other Business Income</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 3: Total Business Income</h3>
                  <p className="text-slate-600 text-sm mb-3">
            ...
            <section id="part-3-expenses" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Part 3: Expenses</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Common Expense Lines</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Office Expenses</h4>
                      <ul className="space-y-1 text-slate-600 text-sm">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Business Expenses</h4>
                      <ul className="space-y-1 text-slate-600 text-sm">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line-by-Line Guide</h3>
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 1: Office Supplies</h4>
                      <p className="text-slate-600 text-sm">Enter the cost of office supplies, paper, pens, etc.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 2: Professional Fees</h4>
                      <p className="text-slate-600 text-sm">Enter legal, accounting, and other professional service fees.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 3: Insurance</h4>
                      <p className="text-slate-600 text-sm">Enter business insurance premiums.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 4: Interest and Bank Charges</h4>
                      <p className="text-slate-600 text-sm">Enter interest on business loans and bank fees.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 5: Meals and Entertainment</h4>
                      <p className="text-slate-600 text-sm">Enter 50% of business meals and entertainment expenses.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 6: Office Rent</h4>
                      <p className="text-slate-600 text-sm">Enter office rent (if not home office).</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 7: Repairs and Maintenance</h4>
                      <p className="text-slate-600 text-sm">Enter repairs and maintenance costs for business equipment.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 8: Supplies</h4>
                      <p className="text-slate-600 text-sm">Enter other business supplies not included elsewhere.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 9: Telephone and Utilities</h4>
                      <p className="text-slate-600 text-sm">Enter business portion of phone and utility bills.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 10: Travel</h4>
                      <p className="text-slate-600 text-sm">Enter business travel expenses (excluding meals).</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 11: Motor Vehicle Expenses</h4>
                      <p className="text-slate-600 text-sm">Enter business portion of vehicle expenses.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-2">Line 12: Other Expenses</h4>
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Total Expenses</h3>
                  <p className="text-slate-600 text-sm mb-3">
            ...
            <section id="part-4-net-income" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Part 4: Net Income</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 1: Net Business Income</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 2: CPP Contributions</h3>
                  <p className="text-slate-600 text-sm mb-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Line 3: Final Net Income</h3>
                  <p className="text-slate-600 text-sm mb-3">
            ...
            <section id="tips" className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">Tips for Success</h2>
              
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-blue-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-blue-900 mb-4">💡 Filling Tips</h3>
                ...
                <div className="bg-green-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-green-900 mb-4">📊 Organization Tips</h3>
                  <ul className="space-y-2 text-green-800 text-sm">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-200">
              <h3 className="text-2xl font-bold text-slate-900 mb-4 text-center">Need Help with Your T2125?</h3>
