        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <section id="what-is-t2125" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">What is the T2125 Form?</h2>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-6">
                <h3 className="text-lg  text-blue-900 mb-2">Key Points About T2125:</h3>
            ...
            <section id="when-to-use" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">When Do You Need to File T2125?</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
                You must file a T2125 form if you meet any of the following criteria:
              </p>

              <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200 mb-6">
                <h3 className="text-lg  text-slate-900 mb-4">Filing Requirements:</h3>
            ...
            <section id="form-sections" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Understanding T2125 Sections</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
            ...
            <section id="common-deductions" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Common Deductions You Can Claim</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full bg-white rounded-lg shadow-sm border border-slate-200">
                  <thead className="bg-slate-50">
                    <tr>
                      <th className="px-6 py-3 text-left text-sm  text-slate-900">Expense Category</th>
                      <th className="px-6 py-3 text-left text-sm  text-slate-900">Examples</th>
                      <th className="px-6 py-3 text-left text-sm  text-slate-900">Notes</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200">
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Office Supplies</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Home Office</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Professional Development</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Vehicle Expenses</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Professional Services</td>
                    ...
                    <tr>
                      <td className="px-6 py-4 text-sm  text-slate-900">Marketing & Advertising</td>
              ...
              <div className="bg-green-50 border-l-4 border-green-400 p-6 mb-6">
                <h3 className="text-lg  text-green-900 mb-2">Pro Tip:</h3>
            ...
            <section id="filling-out-form" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Step-by-Step: Filling Out T2125</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="space-y-8">
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Step 1: Complete Part 1 - Identification</h3>
                  <ul className="space-y-2 text-slate-600">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Step 2: Complete Part 2 - Income</h3>
                  <ul className="space-y-2 text-slate-600">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Step 3: Complete Part 3 - Expenses</h3>
                  <ul className="space-y-2 text-slate-600">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
                  <h3 className="text-xl  text-slate-900 mb-4">Step 4: Complete Part 4 - Net Income</h3>
                  <ul className="space-y-2 text-slate-600">
            ...
            <section id="record-keeping" className="mb-12">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6">
                <h3 className="text-lg  text-yellow-900 mb-2">Retention Period:</h3>
                <p className="text-yellow-800">
            ...
            <section id="next-steps" className="mb-12">
              <h2 className="text-3xl  text-slate-900 mb-6">Next Steps and Resources</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-blue-50 rounded-lg p-6">
                  <h3 className="text-lg  text-blue-900 mb-4">Immediate Actions</h3>
                ...
                <div className="bg-green-50 rounded-lg p-6">
                  <h3 className="text-lg  text-green-900 mb-4">Long-term Planning</h3>
                  <ul className="space-y-2 text-green-800 text-sm">
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg border border-slate-200">
                <h3 className="text-2xl  text-slate-900 mb-4 text-center">Ready to Calculate Your T2125?</h3>
