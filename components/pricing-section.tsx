...
const pricingPlans = [
  {
    name: "Starter",
    price: "Free",
    description: "Perfect for getting started with Tallo",
  ...
  },
  {
    ...
    monthlyPrice: 29,
    annualPrice: 24,
    description: "For professionals who want to save time",
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 99,
    annualPrice: 79,
    description: "For businesses who want to save even more time",
    features: [
      "Everything in Pro",
      "Team collaboration",
